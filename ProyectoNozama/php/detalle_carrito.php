            ...
            <?php 
                if (!empty($productos)) {
                    ...
                    foreach ($productos as $producto) {
                        ...
                        $imagen_base64 = base64_encode($producto['Imagen']); // Codifica la imagen
                        $tipo_mime = 'image/jpeg'; // Cambia si tu imagen no es JPEG
                        echo '<tr>
                                <td><img src="data:' . $tipo_mime . ';base64,' . $imagen_base64 . '" alt="' . $producto['ProductoNombre'] . '" class="img-fluid" style="max-width: 100px;"></td>
